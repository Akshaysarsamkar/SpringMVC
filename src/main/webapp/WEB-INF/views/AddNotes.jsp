...
<body style="background-color: #f8f8ff;">
	<div class="container mt-5">
		<div class="card p-3 container" style="background-color: #ffffff;">
			<form action="showNotes" method="post">
				...
				<div class="form-group">
					...
					<textarea class="form-control" id="exampleFormControlTextarea1"
						rows="3" name="product_des"></textarea>
				</div>
				<div class="text-center">
					<button type="submit" class="btn btn-primary btn-lg">Add</button>
					<a href="${ pageContext.request.contextPath  }/" class="btn btn-outline-danger  btn-lg mr-3">Back</a>
				</div>	
			</form>
		</div>
	</div>
